...
from .models import Users, Volunteers
...
class RegistrationForm(UserCreationForm):
    ...
    def save(self, commit=True):
        ...
        if commit:
            user.save()
            Users.objects.create(user=user, phone=self.cleaned_data['phone'])
        return user
...
class UserProfileForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['phone'].required = False  # Assuming phone is a required field